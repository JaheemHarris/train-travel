 ...
 * @author HP
 */
@WebServlet(name = "SimpleSearch", urlPatterns = {"/SimpleSearch"})
public class SimpleSearch extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idVilleDepart = request.getParameter("villeDepart");
        String idVilleDestination = request.getParameter("villeDestination");
        String dateVoyage = request.getParameter("dateDepart");
        DbAccess dbConnex = new DbAccess();
        ClientService clientService = new ClientService();
        ArrayList<ArrayList> searchResult = new ArrayList();
        searchResult = clientService.rechercheSimple(idVilleDepart, idVilleDestination, dbConnex);
