  ...
  <tbody>
      ...
      <% trajetTemp=listeTrajet.get(i); %>
        <tr>
          ...
          <td><a href="admin/ModifyTrajet?idTrajet=<%=trajetTemp.getIdTrajet()%>"><i class="far fa-edit"></i></a></td>
          <td><a href="admin/DeleteTrajet?id=<%=trajetTemp.getIdTrajet()%>"><i class="far fa-trash-alt"></i></a></td>
        </tr>
      <% } %>
  </tbody>
</table>