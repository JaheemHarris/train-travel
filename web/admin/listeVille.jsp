  ...
  <tbody>
      ...
      <% villeTemp=listeVille.get(i); %>
        <tr>
          ...
          <td><a href="ModifyVille?idVille=<%=villeTemp.getIdVille()%>"><i class="far fa-edit"></i></a></td>
          <td><a href="DeleteVille?id=<%=villeTemp.getIdVille()%>"><i class="far fa-trash-alt"></i></a></td>
        </tr>
       <% } %>
  </tbody>
</table>