  ...
  <tbody>
      ...
      <% trainTemp=listeTrain.get(i); %>
        <tr>
          ...
          <td><a href="ModifyTrain?idTrain=<%=trainTemp.getIdTrain()%>"><i class="far fa-edit"></i></a></td>
          <td><a href="DeleteTrain?id=<%=trainTemp.getIdTrain()%>"><i class="far fa-trash-alt"></i></a></td>
        </tr>
      <% } %>
  </tbody>
</table>