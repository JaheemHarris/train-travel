  ...
  <tbody>
      ...
      <% compagnieTemp=listeCompagnie.get(i); %>
        <tr>
          ...
          <td><a href="admin/ModifyCompagnie?idCompagnie=<%=compagnieTemp.getIdCompagnie()%>"><i class="far fa-edit"></i></a></td>
          <td><a href="admin/DeleteCompagnie?id=<%=compagnieTemp.getIdCompagnie()%>"><i class="far fa-trash-alt"></i></a></td>
        </tr>
       <% } %>
  </tbody>
</table>